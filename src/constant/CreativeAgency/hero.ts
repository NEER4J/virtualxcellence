...
const hero:HeroData = {
  ...
  subtitle: "- Start with Virtual Xcellence.",
  description:
    "Virtual Xcellence, a digital agency crafted by a dedicated team of creatives champions the essence of simplicity and elegance.",
  cta: {
    text: "Let’s Connect",
