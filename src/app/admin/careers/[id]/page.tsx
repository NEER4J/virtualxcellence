...
import { ArrowLeft, Save, Plus, Trash2, Eye, ExternalLink } from 'lucide-react'
...
export default function CareerEditPage({ params }: CareerEditPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Failed to update career post. Please try again.')
    } finally {
  ...
  const deleteCareer = async () => {
    if (!confirm('Are you sure you want to delete this career post? This action cannot be undone.')) return
    ...
    try {
      ...
      toast.error('Failed to delete career post. Please try again.')
    }
  }
      ...
      <div className="flex h-screen bg-gray-50">
        ...
        <main className="flex-1 overflow-y-auto flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Loading career post...</p>
          </div>
        </main>
      </div>
    )
  ...
  if (!career) {
    return (
      <div className="flex h-screen bg-gray-50">
        ...
        <main className="flex-1 overflow-y-auto flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Career post not found</h2>
            <p className="text-gray-600 mb-4">The career post you&apos;re looking for doesn&apos;t exist.</p>
            <Link
              href="/admin/careers"
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl font-semibold text-gray-900">Edit Career Post</h1>
                  <p className="text-gray-500 text-sm">Update job posting details</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <Link
