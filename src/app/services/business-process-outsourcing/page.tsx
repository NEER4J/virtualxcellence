...
export async function generateMetadata(): Promise<Metadata> {
  return createRuntimePageMetadata('/services/business-process-outsourcing', {
    title: "Business Process Outsourcing (BPO) & Support Services || Virtual Xcellence - Creative Digital Agency NextJS Template",
    description: "Transform your operations with scalable, cost-effective outsourcing. Virtual Xcellence BPO services include customer support, back-office operations, sales & lead generation, technical support, and AI-powered solutions.",
    keywords: [
    ...
    canonicalUrl: "https://virtualxcellence.com/services/business-process-outsourcing"
  });
}
